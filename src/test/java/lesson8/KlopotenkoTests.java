...
public class KlopotenkoTests {
    //вынесли отдельно все наши локаторы
    ...
    public void pageSourceCheckout() {
        ...
        myWaiters.waitPresenceOfElement(Locators.entranceGoogle);//дождались появление хотя бы первого элемента
        assertTrue(driver.findElement(Locators.entranceGoogle).isDisplayed());//проверяем отображается ли данный элемент
        assertTrue(driver.findElement(Locators.checkBox).isDisplayed());//проверяем отображается ли данный элемент
        assertTrue(driver.findElement(Locators.loginField).isDisplayed());//проверяем отображается ли данный элемент
        assertTrue(driver.findElement(Locators.passField).isDisplayed());//проверяем отображается ли данный элемент
        assertTrue(driver.findElement(Locators.LoginButton).isDisplayed());//проверяем отображается ли данный элемент
        assertTrue(driver.findElement(Locators.SighInButton).isDisplayed());//проверяем отображается ли данный элемент
    }
