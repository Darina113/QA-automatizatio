...
public class WebElementLessons {
 ...
 /*       driver.get("https://rozetka.com.ua/ua/");
        ...
        search.sendKeys("Samsung");//вводим samsung
        Thread.sleep(4000);
        search.sendKeys(Keys.DOWN);//опускаемся вниз
        Thread.sleep(4000);
        search.sendKeys(Keys.DOWN);//опускаемся вниз
        Thread.sleep(4000);
        ...
        System.out.println(search.getAttribute("placeholder")); //placeholder - атрибут, получаем его инфу через гет.атрибут
        System.out.println(search.getCssValue("background-image"));
        System.out.println(buttonSearch.getTagName()); //полуаем название имени тега элемента
        System.out.println(buttonSearch.getText());//получаем текст элемента
        driver.quit();
        ...
        WebElement search = driver.findElement(By.xpath("//input[@placeholder='Я шукаю...']"));
        WebElement buttonSearch = driver.findElement(By.cssSelector(".button.button_color_green.button_size_medium.search-form__submit.ng-star-inserted"));
        System.out.println("Местонахождение верхнего левого угла элемента " + search.getLocation());//координаты х и у
        System.out.println("Координата x верхнего левого угла элемента " + search.getLocation().x);//координата х
        System.out.println("Координата y верхнего левого угла элемента " + search.getLocation().y);//координата у

        System.out.println("Размер нашей кнопки "+ buttonSearch.getSize()); //ширина и высота
        System.out.println("Высота нашей кнопки "+ buttonSearch.getSize().height);//высота
        System.out.println("Ширина нашей кнопки "+ buttonSearch.getSize().width);//ширина
